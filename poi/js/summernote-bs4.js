...
(function (factory) {
  ...
  var ui = {
    ...
    button: function ($node, options) {
      return renderer.create('<button type="button" class="note-btn btn btn-sm btn-transparent c-grey" tabindex="-1" style="color: #4F748E; float: left; background-color: #fff">', function ($node, options) {
