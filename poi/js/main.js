...
(function ($) {
    ...
    CRUMINA.TopSearch = function () {
        $('.js-user-search').selectize({
            ...
            searchField: ['name'],
            options: [
                {image: 'img/avatar22-sm.jpg', name: 'Labuan Bajo' },
                {image: 'img/avatar23-sm.jpg', name: 'Pulau Derawan' },
                {image: 'img/avatar24-sm.jpg', name: 'Labuan Cermin' },
                {image: 'img/avatar25-sm.jpg', name: 'Gunung Rinjani' },
                {image: 'img/avatar26-sm.jpg', name: 'Pulau Komodo' },
                {image: 'img/avatar27-sm.jpg', name: 'Gunung Bromo' }
            ],
            render: {
